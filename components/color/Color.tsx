...
export function Color({ color, onPress, selected }: ColorProps) {
  ...
  return (
    ...
    >
      {color === "#F0F0F0" && (
        <>
          <div className="w-4 h-8 rounded-l-full" style={{ backgroundColor: "black" }} />
          <div className="w-4 h-8 rounded-r-full " style={{ backgroundColor: "white" }} />
        </>
      )}
      {
        selected && (
          <div className="w-8 h-8 rounded-full flex items-center justify-center absolute" >
            <div className="w-4 h-4 rounded-full flex flex-row relative bg-white" >
              {color === "#F0F0F0" && (
                <>
                  <div className="w-4 h-4 rounded-l-full" style={{ backgroundColor: "white" }} />
                  <div className="w-4 h-4 rounded-r-full " style={{ backgroundColor: "black" }} />
                </>
              )}
              <div />
            </div>
